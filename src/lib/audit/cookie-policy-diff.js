...
function cookiePolicyDiff({ corpus = [], trackers = [] }) {
  ...
  return {
    ...
    finding: {
      ...
      enforcement_example: 'ICO under PECR: enforcement notices and fines up to GBP 17.5 million or 4% of global annual turnover (Data (Use and Access) Act 2025, in force 5 February 2026), plus GDPR-level fines where consent is the lawful basis',
