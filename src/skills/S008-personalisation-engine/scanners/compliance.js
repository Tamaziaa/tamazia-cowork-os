...
async function scan({ domain, sector, country, cache_max_age = 86400, signals = {} }) {
  ...
  const ENGINE_VERSION = process.env.COMPLIANCE_ENGINE_VERSION || 'v25.7-2026-07-corpus-truncation';
...
module.exports = { ENGINE_VERSION: (process.env.COMPLIANCE_ENGINE_VERSION || 'v25.7-2026-07-corpus-truncation'), scan, ruleCheck, gatherCorpus, loadRules };
