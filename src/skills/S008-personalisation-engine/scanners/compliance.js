...
async function scan({ domain, sector, country, cache_max_age = 86400, signals = {} }) {
  ...
  const ENGINE_VERSION = process.env.COMPLIANCE_ENGINE_VERSION || 'v25.1-2026-07-ast-coherence';
...
module.exports = { ENGINE_VERSION: (process.env.COMPLIANCE_ENGINE_VERSION || 'v25.1-2026-07-ast-coherence'), scan, ruleCheck, gatherCorpus, loadRules };
