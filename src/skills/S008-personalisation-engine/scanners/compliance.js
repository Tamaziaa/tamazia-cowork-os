...
async function scan({ domain, sector, country, cache_max_age = 86400, signals = {} }) {
  ...
  const ENGINE_VERSION = process.env.COMPLIANCE_ENGINE_VERSION || 'v25.6-2026-07-fine-one-door';
...
module.exports = { ENGINE_VERSION: (process.env.COMPLIANCE_ENGINE_VERSION || 'v25.6-2026-07-fine-one-door'), scan, ruleCheck, gatherCorpus, loadRules };
