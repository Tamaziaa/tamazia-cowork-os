...
async function scan({ domain, sector, country, cache_max_age = 86400, signals = {} }) {
  ...
  const ENGINE_VERSION = process.env.COMPLIANCE_ENGINE_VERSION || 'v25.2-2026-07-host-anchoring';
...
module.exports = { ENGINE_VERSION: (process.env.COMPLIANCE_ENGINE_VERSION || 'v25.2-2026-07-host-anchoring'), scan, ruleCheck, gatherCorpus, loadRules };
