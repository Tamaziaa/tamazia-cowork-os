...
async function scan({ domain, sector, country, cache_max_age = 86400, signals = {} }) {
  ...
  const ENGINE_VERSION = process.env.COMPLIANCE_ENGINE_VERSION || 'v23.11-2026-07-cookie-domcontentloaded';
...
module.exports = { ENGINE_VERSION: (process.env.COMPLIANCE_ENGINE_VERSION || 'v23.11-2026-07-cookie-domcontentloaded'), scan, ruleCheck, gatherCorpus, loadRules };
