...
const PROMPT = t => `You tag which business SECTORS a regulation governs. Choose ONLY from this fixed list: ${LIST}. Return STRICT JSON: {"sectors":["..."]} using ONLY listed values, each with clear grounding in the text; return [] if none clearly apply. Regulation:\n"""${String(t).slice(0, 3000)}"""\nJSON only.`;
