...
function pg(sql){ return execFileSync(path.join(__dirname,'psql'),[NEON,'-tA','-c',sql],{encoding:'utf8',maxBuffer:128*1024*1024}); }  // maxBuffer: 5 base64 bodies x up to 200 leads exceed Node's 1MB default (ENOBUFS -> silent no-push)
